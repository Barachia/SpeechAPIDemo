...
/**
 * Class made for convenience with Flipper and communicating is possible via Middleware or the Java API.
 */
public class SpraakApp {
        ...
        public void run(){
            ...
            try {
                ...
                if (shouldRestartListener) { 
                	logger.error("Server closec connected, will restart to connect!");
                	startCapturingAudio();
                }
            }
        }
